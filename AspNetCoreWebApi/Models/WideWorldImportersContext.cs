...
public partial class WideWorldImportersContext : DbContext
{
    ...
    public virtual DbSet<GarthDeviceInfo> GarthDeviceInfos { get; set; }

    public virtual DbSet<GarthDeviceInfo2> GarthDeviceInfo2s { get; set; }

    public virtual DbSet<GarthLog> GarthLogs { get; set; }

    public virtual DbSet<GarthTest1> GarthTest1s { get; set; }

    public virtual DbSet<GarthTest11> GarthTest11s { get; set; }
    ...
    public virtual DbSet<Results3> Results3s { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-0G28D3G;Database=WideWorldImporters;Trusted_Connection=True;user id=sa;password=11111111;trustservercertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<GarthCompany>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__GarthCom__3214EC27BF34EF16");

            entity.ToTable("GarthCompany");
        ...
        modelBuilder.Entity<GarthDevice>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__GarthDev__3214EC27A9EF8414");

            entity.ToTable("GarthDevice");
            ...
            entity.Property(e => e.PositionOfDevice)
                .HasMaxLength(50)
                .HasColumnName("positionOfDevice");
            ...
            entity.HasOne(d => d.Company).WithMany(p => p.GarthDevices)
                .HasForeignKey(d => d.CompanyId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("FK__GarthDevi__compa__4EA8A765");
        });

        modelBuilder.Entity<GarthDeviceInfo>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__GarthDev__3214EC27C6D18E53");

            entity.ToTable("GarthDeviceInfo");
        ...
        modelBuilder.Entity<GarthDeviceInfo2>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__GarthDev__3214EC27C21761AC");

            entity.ToTable("GarthDeviceInfo2");
        ...
        modelBuilder.Entity<GarthLog>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__GarthLog__3214EC27C920CE81");

            entity.ToTable("GarthLog");

            entity.Property(e => e.Id).HasColumnName("ID");
            entity.Property(e => e.DeviceConfig).HasMaxLength(2000);
            entity.Property(e => e.DeviceId).HasColumnName("device_ID");
            entity.Property(e => e.DeviceLog).HasMaxLength(2000);
            entity.Property(e => e.LogDate)
                .HasColumnType("datetime")
                .HasColumnName("logDate");

            entity.HasOne(d => d.Device).WithMany(p => p.GarthLogs)
                .HasForeignKey(d => d.DeviceId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("FK__GarthLog__device__51851410");
        });

        modelBuilder.Entity<GarthTest1>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("GarthTest1", "GarthSchema");
            ...
            entity.Property(e => e.SqlVariable).HasColumnType("sql_variant");
        });

        modelBuilder.Entity<GarthTest11>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__GarthTes__3214EC27C1B980AF");

            entity.ToTable("GarthTest11");
        ...
        modelBuilder.Entity<Results3>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Results3");

            entity.Property(e => e.ColumnName).HasMaxLength(370);
            entity.Property(e => e.ColumnValue).HasMaxLength(3630);
        });
